...
static unsigned int gpioLED = 16;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 26;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
