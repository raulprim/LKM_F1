...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Raul Prim");
MODULE_DESCRIPTION("A Button/LED test driver for the BBB");
MODULE_VERSION("0.1");

static unsigned int gpioLED = 20;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 13;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
